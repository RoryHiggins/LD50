...
odLogContext_construct(const char* file, const char* function, uint32_t line);

OD_API_C OD_ENGINE_CORE_MODULE void
odLog_log_variadic(struct odLogContext logger, uint32_t log_level, const char* format_c_str, va_list args);
OD_API_C OD_ENGINE_CORE_MODULE void
odLog_log(struct odLogContext logger, uint32_t log_level, const char* format_c_str, ...) OD_API_PRINTF(3, 4);
OD_API_C OD_ENGINE_CORE_MODULE void
