...
OD_API_C OD_ENGINE_CORE_MODULE uint32_t odArray_get_capacity(const struct odArray* array);
OD_API_C OD_ENGINE_CORE_MODULE bool odArray_set_capacity(struct odArray* array, uint32_t new_capacity);
OD_API_C OD_ENGINE_CORE_MODULE bool odArray_ensure_capacity(struct odArray* array, uint32_t min_capacity);
...
OD_API_C OD_ENGINE_CORE_MODULE void* odArray_get(struct odArray* array, uint32_t i);
OD_API_C OD_ENGINE_CORE_MODULE const void* odArray_get_const(const struct odArray* array, uint32_t i);
