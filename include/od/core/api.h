...
#if !defined(OD_BUILD_DLL_ENGINE_CORE)
#define OD_BUILD_DLL_ENGINE_CORE 0
#endif
...
#if OD_BUILD_DLL_ENGINE_CORE
#define OD_API_LINKAGE_SHARED OD_API_LINKAGE_EXPORT
#else
#define OD_API_LINKAGE_SHARED OD_API_LINKAGE_IMPORT
#endif

#define OD_API_CORE_C OD_API_LINKAGE_NAMES_C OD_API_LINKAGE_SHARED 
#define OD_API_CORE_CPP OD_API_LINKAGE_SHARED 
