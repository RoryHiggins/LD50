...
OD_API_C void odWindow_close(struct odWindow* window);
OD_API_C void odWindow_step(struct odWindow* window);
OD_API_C bool odWindow_set_visible(struct odWindow* window, bool is_visible);
OD_API_C bool odWindow_get_open(const struct odWindow* window);
OD_API_C const struct odWindowSettings* odWindow_get_settings(const struct odWindow* window);
