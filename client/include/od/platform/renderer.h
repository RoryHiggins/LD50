...
OD_API_C OD_ENGINE_PLATFORM_MODULE bool odRenderer_draw(struct odRenderer* renderer, const struct odVertex* vertices, int32_t vertices_count, struct odRenderViewport viewport);
