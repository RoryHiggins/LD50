...
OD_API_C OD_ENGINE_CORE_MODULE int32_t odArray_get_capacity(const struct odArray* array);
OD_API_C OD_ENGINE_CORE_MODULE bool odArray_set_capacity(struct odArray* array, int32_t new_capacity);
OD_API_C OD_ENGINE_CORE_MODULE bool odArray_ensure_capacity(struct odArray* array, int32_t min_capacity);
OD_API_C OD_ENGINE_CORE_MODULE void odArray_release(struct odArray* array);
OD_API_C OD_ENGINE_CORE_MODULE int32_t odArray_get_count(const struct odArray* array);
OD_API_C OD_ENGINE_CORE_MODULE bool odArray_set_count(struct odArray* array, int32_t new_count);
