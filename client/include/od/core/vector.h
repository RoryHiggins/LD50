...
OD_API_C OD_CORE_MODULE OD_NO_DISCARD bool
odVector_get_equals(const struct odVector* vector1, const struct odVector* vector2);
OD_API_C OD_CORE_MODULE OD_NO_DISCARD bool
odVector_epsilon_get_equals(const struct odVector* vector1, const struct odVector* vector2);
