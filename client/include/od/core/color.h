...
odColor_equals(const struct odColor* color1, const struct odColor* color2);
OD_API_C OD_CORE_MODULE void
odColor_blit(int32_t width, int32_t height, const struct odColor* src, int32_t src_row_stride,
				   struct odColor* dest, int32_t dest_row_stride);
