...
OD_API_C OD_ENGINE_CORE_MODULE bool odAllocation_get_valid(const struct odAllocation* allocation);
OD_API_C OD_ENGINE_CORE_MODULE bool odAllocation_allocate(struct odAllocation* allocation, int32_t size);
